...
type ExamAttempt struct {
	...
	ExamID         uint       `gorm:"index:idx_attempt_exam_student;not null" json:"exam_id"`
	StudentID      uint       `gorm:"index:idx_attempt_exam_student;index;not null" json:"student_id"`
	Kind           string     `gorm:"size:16;not null;default:normal" json:"kind"`
